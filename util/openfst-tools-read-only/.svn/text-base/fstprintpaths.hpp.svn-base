...
class fstprintpaths
{
    ...
    static void printAllStrings(StdVectorFst& fst, SymbolTable& st, string& seqToSkip, ProjectionEnum printInputOrOutput = PROJECT_OUTPUT);

    static void printAllStringsHelper(StdVectorFst& fst, SymbolTable& st, int state, string& str, TropicalWeight cost, string& seqToSkip, ProjectionEnum printInputOrOutput=PROJECT_OUTPUT); 
